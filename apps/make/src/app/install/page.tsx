      ...
      <div className={styles.modal}>
        ...
        {active === '1' && (
          <InstructionItems
            ...
            instructions={[
              'Sign in to Make and click your avatar at the bottom-left corner of the page. Then, click Profile',
              'Open the API tab. Then, click Add token',
              'In the Add token dialog, do the following: Label — type a custom name for your token that will help you recognize what the token is used for . Scopes — select the scopes you need for working with API resources. For more information about scopes.',
              'Click Save.',
              'Note: Copy the token and store it somewhere safe as it will not be shown again after leaving that page.',
            ]}
          />
        )}
        {active === '2' && (
        ...
        {active === '3' && (
          <>
            <InstructionItems heading="Link Application" instructions={[]} />
